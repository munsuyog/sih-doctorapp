...
import { loginPatient, fetchPatientByEmail } from '../../features/connectDb';
...
const PatientLogin = ({ navigation }) => {
    ...
    const loginHandler = () => {
        loginPatient(patientLoginData, setLoginSuccess, setLoggedPatient)
        fetchPatientByEmail(patientLoginData.email, setPatientData)
                ...
                <View style={{ marginBottom: 12 }}>
                    ...
                    <View style={{
                        ...
                        <TextInput
                            ...
                            onChangeText={(input)=>{setPatientLoginData({...patientLoginData, email: input})}}
                            style={{
                                width: "100%"
                            }}
                        />
                ...
                <View style={{ marginBottom: 12 }}>
                    ...
                    <View style={{
                        ...
                        <TextInput
                            ...
                            onChangeText={(input)=>{setPatientLoginData({...patientLoginData, password: input})}}
                        />
